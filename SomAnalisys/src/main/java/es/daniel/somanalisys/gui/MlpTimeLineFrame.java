...
public class MlpTimeLineFrame extends JFrame implements Runnable,ModelManagerListener {
    private TimePanel time;
    private Thread thread;
    private BasicModelManager modelMgr;
    private PairDataManager dataMgr;


    public MlpTimeLineFrame(){
        dataMgr=new PairDataManager();
        modelMgr=new BasicModelManager();
